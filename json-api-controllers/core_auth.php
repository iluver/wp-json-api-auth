<?php
/*
Controller name: Core_Auth
Controller description: Basic introspection methods with auth to work with Matt Berg's auth modifications
Controller Author: David Gross
*/

class JSON_API_Core_Auth_Controller {


  public function info() {
    global $json_api;
    
    $this->confirm_auth() || return false;
